"""Lightweight persistent semantic index.

Set `SEMANTIC_EMBEDDINGS=true` to enable sentence-transformers. The fallback token scorer
keeps startup deterministic when model downloads are disabled.
"""
